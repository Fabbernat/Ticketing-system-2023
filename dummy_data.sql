...
INSERT INTO felhasznalo (felhasznalonev, email, jelszo, vezeteknev, keresztnev, szerep, jegyek_darabszama) VALUES
('user1', 'user1@example.com', 'password1', 'John', 'Doe', 'Felhasználó',0),
('admin1', 'admin1@example.com', 'adminpassword', 'Admin', 'Admin', 'Adminisztrátor',0);
('','','','','','',0),
