<!DOCTYPE html> <html lang=“en”> <head> <meta charset=“UTF-8”> <title>Felhasználók listázása</title> </head> <body>

<a href="../index.php">Vissza a főoldalra</a> <table> <?php include_once "dbh.inc.php";
